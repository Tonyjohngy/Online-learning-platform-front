    ...
    <td colspan="3" class="Title red f18 fb"><p>限时折扣</p></td>
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          <label for="Agree">
            <p class="on"><input type="checkbox" id="agreeChecked" v-model="agreed" checked="checked">我已阅读并同意<a href="protocol" >《购买协议》</a></p>
          </label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
        ...
        <button class="fr redb" type="button" @click="toPay()">去支付</button>
        <div class="clear"></div>
      </div>
    </form>
  </div>
