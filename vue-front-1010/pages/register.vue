<template>
  <div class="main">
    ...
    required: true, message: '请输入你的昵称', trigger: 'blur' }]">
        ...
        <el-form-item class="input-prepend restyle no-radius" prop="mobile" :rules="[{ required: true, message: '请输入手机号码', trigger: 'blur' },{validator:
  ...
  methods: {
    getCodeFun() {
      ...
      this.$refs.userForm.validateField('mobile', (errMsg) => {
        if (errMsg == '') {
          registerApi.sendMsm(this.params.mobile).then((res) => {
            this.sending = false
            this.timeDown()
          })
        }
